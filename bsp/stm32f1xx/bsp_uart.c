...
DEFINE_DEVICE_REGISTER_ITEM(USART1_BASE, UART1_INDEX)
DEFINE_DEVICE_REGISTER_ITEM(USART2_BASE, UART2_INDEX)
DEFINE_DEVICE_REGISTER_ITEM(USART3_BASE, UART3_INDEX)
