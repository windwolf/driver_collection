...
static void packet_parser_test1_1()
{
...
static void packet_parser_test1_2()
{
    uint8_t prefix[7] = {0xFA, 0xFB, 0xFC, 0xFD, 0xFA, 0xFB, 0xFD};
    uint8_t buf[64] = {0};
    RingBuffer rb;
...
static void packet_parser_test2_1()
{
...
static void packet_parser_test2_2()
{
    uint8_t prefix[2] = {0xEF, 0xFF};
    PacketSchema schema = {
        .mode = PACKET_SCHEMA_MODE_DYNAMIC_LENGTH,
...
{
    packet_parser_test1_1();
    packet_parser_test1_2();
    packet_parser_test2_1();
    packet_parser_test2_2();
};
