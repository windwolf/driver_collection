...
void ssd1306_demo(void) {
    ...
    while (1) {
        FONTS_FillData(ZJ0_96in.dataBuffer, &canvasInfo_ZJ0_96in, 0, 0, "0123456789ABCDEFGHIJK",
                       &Font6x8_v, &fontDrawInfo);
        FONTS_FillData(ZJ0_96in.dataBuffer, &canvasInfo_ZJ0_96in, 0, 8, "123456789ABCDEFGHIJK0",
                       &Font6x8_v, &fontDrawInfo);
        FONTS_FillData(ZJ0_96in.dataBuffer, &canvasInfo_ZJ0_96in, 0, 16, "23456789ABCDEFGHIJK01",
                       &Font6x8_v, &fontDrawInfo);
        FONTS_FillData(ZJ0_96in.dataBuffer, &canvasInfo_ZJ0_96in, 0, 24, "3456789ABCDEFGHIJK012",
                       &Font6x8_v, &fontDrawInfo);
        FONTS_FillData(ZJ0_96in.dataBuffer, &canvasInfo_ZJ0_96in, 0, 32, "456789ABCDEFGHIJK0123",
                       &Font6x8_v, &fontDrawInfo);
        FONTS_FillData(ZJ0_96in.dataBuffer, &canvasInfo_ZJ0_96in, 0, 40, "56789ABCDEFGHIJK01234",
                       &Font6x8_v, &fontDrawInfo);
        FONTS_FillData(ZJ0_96in.dataBuffer, &canvasInfo_ZJ0_96in, 0, 48, "6789ABCDEFGHIJK012345",
                       &Font6x8_v, &fontDrawInfo);
        FONTS_FillData(ZJ0_96in.dataBuffer, &canvasInfo_ZJ0_96in, 0, 56, "789ABCDEFGHIJK0123456",
                       &Font6x8_v, &fontDrawInfo);
        ZJ0_96in.draw();
        LOG_I("0.96in OLED drawed");

        FONTS_FillData(ZJ0_91in.dataBuffer, &canvasInfo_ZJ0_91in, 0, 0, "0", &Font6x8_v,
                       &fontDrawInfo);
        FONTS_FillData(ZJ0_91in.dataBuffer, &canvasInfo_ZJ0_91in, 0, 8, "1", &Font6x8_v,
                       &fontDrawInfo);
        FONTS_FillData(ZJ0_91in.dataBuffer, &canvasInfo_ZJ0_91in, 0, 16, "2", &Font6x8_v,
                       &fontDrawInfo);
        FONTS_FillData(ZJ0_91in.dataBuffer, &canvasInfo_ZJ0_91in, 0, 24, "3", &Font6x8_v,
                       &fontDrawInfo);
        // FONTS_FillData(ZJ0_91in.dataBuffer, &canvasInfo_ZJ0_91in, 0, 0, "0123456789ABCDEFGHIJK",
        // &Font6x8_v, &fontDrawInfo); FONTS_FillData(ZJ0_91in.dataBuffer, &canvasInfo_ZJ0_91in, 0,
        // 8, "123456789ABCDEFGHIJK0", &Font6x8_v, &fontDrawInfo);
        // FONTS_FillData(ZJ0_91in.dataBuffer, &canvasInfo_ZJ0_91in, 0, 16, "23456789ABCDEFGHIJK01",
        // &Font6x8_v, &fontDrawInfo); FONTS_FillData(ZJ0_91in.dataBuffer, &canvasInfo_ZJ0_91in, 0,
        // 24, "3456789ABCDEFGHIJK012", &Font6x8_v, &fontDrawInfo);
        // FONTS_FillData(ZJ0_91in.dataBuffer, &canvasInfo_ZJ0_91in, 0, 32, "456789ABCDEFGHIJK0123",
        // &Font6x8_v, &fontDrawInfo); FONTS_FillData(ZJ0_91in.dataBuffer, &canvasInfo_ZJ0_91in, 0,
        // 40, "56789ABCDEFGHIJK01234", &Font6x8_v, &fontDrawInfo);
        // FONTS_FillData(ZJ0_91in.dataBuffer, &canvasInfo_ZJ0_91in, 0, 48, "6789ABCDEFGHIJK012345",
        // &Font6x8_v, &fontDrawInfo); FONTS_FillData(ZJ0_91in.dataBuffer, &canvasInfo_ZJ0_91in, 0,
        // 56, "789ABCDEFGHIJK0123456", &Font6x8_v, &fontDrawInfo);
        ZJ0_91in.draw();
