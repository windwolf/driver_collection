#ifndef ___SSD1306_H__
#define ___SSD1306_H__
...
#define SSD1306_CMD_BUFFER_SIZE (8)
    ...
    typedef enum SSD1306_MEMORY_ADDRESSING_MODE
    {
    ...
    typedef enum SSD1306_VCOMH_DESELECT_LEVEL
    {
    ...
    typedef struct SSD1306
    {
        ...
        uint8_t width;
        uint8_t height;
        SSD1306_MEMORY_ADDRESSING_MODE memoryMode;
        bool enableChargePump;
        bool comInverted;
        bool segmentInverted;
        bool comLeftRightRemap;
        bool comAlternative;
        ...
        SSD1306_VCOMH_DESELECT_LEVEL vcomhDeselectLevel;
