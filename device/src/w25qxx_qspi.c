// #include "inc/w25qxx/w25qxx_qspi.h"
// #include "bsp.h"

// DEVICE_STATUS w25qxx_qspi_create(W25QXX_SPI *instance, Buffer buffer, SimpleCommand *command)
// {
...
// DEVICE_STATUS w25qxx_qspi_reset(W25QXX_SPI *instance)
// {
